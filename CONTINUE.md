...
Phase A seller-dialog зашиплен. 14 задач + 5 production-фиксов + 1 polling-фикс (gallery) + 2 ship-blocker фикса 2026-05-11 ~10:30 UTC (persistence FK + messenger-bot SSE service). 1 живой dialog в `questions_setup` после manual prime. **Фиксы не закоммичены — нужен commit.** Soak 3-4 дня. После — Phase B brainstorm/plan для Опрос autopilot (~6-7ч кодинга). Spec rev 4 финализирован, дизайн на все 9 этапов закреплён.
